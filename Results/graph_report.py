...
# plt.plot(tasks, mobile, marker='s', linestyle='dashed')
# plt.plot(tasks, vgg, marker='*', linestyle='dashed')
# plt.plot(tasks, custom, marker='D', linestyle='dashed')
# plt.xlim(0,40)
# plt.ylim(0.50,1.05)
# plt.legend(["MobileNetV2", "VGG16", "Custom"])
...
# plt.xlabel("Tasks / Number of Categories")
# plt.ylabel("Global Classification Accuracy")
...
# plt.plot(tasks, t_mobile, marker='s', linestyle='dashed')
# plt.plot(tasks, t_vgg, marker='*', linestyle='dashed')
# plt.plot(tasks, t_custom, marker='D', linestyle='dashed')
# plt.xlim(0,40)
...
plt.plot(tasks, s_mobile, marker='s', linestyle='dashed')
plt.plot(tasks, s_vgg, marker='*', linestyle='dashed')
plt.plot(tasks, s_custom, marker='D', linestyle='dashed')
plt.xlim(0,40)
plt.ylim(1100, 1800)
# a[0].legend(["MobileNetV2", "VGG16", "Custom"])
...
plt.xlabel("Tasks / Number of Categories")
plt.ylabel("Total Neurons in DEN layers")
